...
int main(int argc, char **argv) {
  if (ibutterfree_init(argc, argv) == IBUTTERFREE_OK) {
    ...
    if (ibutterfree_create_surface(&surface, &desc) == IBUTTERFREE_OK) {
      ...
      ibutterfree_draw_image(
          &surface, "../examples/resources/images/IButterFree.bmp", xres / 7,
          yres / 4, xres / 7, xres / 7, IBUTTERFREE_IMAGE_TYPE_BMP);
      ibutterfree_draw_image(
          &surface, "../examples/resources/images/IButterFree.ppm", xres / 4,
          yres / 2, xres / 7, xres / 7, IBUTTERFREE_IMAGE_TYPE_PPM);
      ibutterfree_draw_image(
          &surface, "../examples/resources/images/IButterFree.png", xres / 7,
          yres / 2, xres / 7, xres / 7, IBUTTERFREE_IMAGE_TYPE_PNG);
      ibutterfree_draw_image(
          &surface, "../examples/resources/images/IButterFree.png", xres / 4,
          yres / 4, xres / 7, xres / 7, IBUTTERFREE_IMAGE_TYPE_PNG);
